...
if os.path.exists("./neural-networks-and-deep-learning/data/mnist_expanded.pkl.gz"):
    ...
    f = gzip.open("./neural-networks-and-deep-learning/data/mnist_expanded.pkl.gz", "w")
